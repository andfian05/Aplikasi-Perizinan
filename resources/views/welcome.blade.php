                                ...
                                <div class="carousel-item active">
                                    <div class="img-box b-1">
                                        ...
                                        <lottie-player src="{{asset('Templeate - 2/login.json')}}"
                                            background="transparent" speed="2" height="100%" width="100%"
                                            class="text-center" loop autoplay>
                                        </lottie-player>
                    ...
                    <div class=" col-md-5 offset-md-1">
                        <div class="detail-box"> <br><br>
                            <a href="" class="text-nowrap logo-img text-center d-block py-3 w-100">
                                <img src="{{asset('icon/Petik_YBM2.png')}}" class="rounded mx-auto d-block" width="180"
                                    alt="">
                            </a>
                            <!-- <p class="text-center">Your Health, Our Priority</p> -->
                            <br><br>
                            <h5  class="display-5 lh-1 mb-4">Informasi</h4>

                            <ul class="text-justify">
                                <p class="text-justify mb-1 ">*<b class="text-primary"> Jujur</b>, Mahasantri <b class="text-danger">Wajib</b> mengisi Keterangan izin
                                    keluar asrama dengan detail dan jujur.</p>
                                <p class="text-justify mb-1">*<b class="text-primary"> Sopan</b>, Mahasantri <b class="text-danger">Wajib</b> menggunakan pakaian yang
                                    sopan dan tidak terlalu mencolok (glamour) serta menjaga tata krama Pesantren.</p>

                                <p class="text-justify mb-1">*<b class="text-primary"> Tepat Waktu</b>, Mahasantri <b class="text-danger">Wajib</b> tepat waktu dalam
                                    masuk Pesantren sesuai dengan jadwal masuk Pesantren.</p>
                                <p class="text-justify mb-1">*<b class="text-primary"> Tanggung Jawab</b>, Mahasantri <b class="text-danger">Wajib</b> menerima
                                    konsenkuensi sanksi apabila terlambat masuk Pesantren.</p>

                            </ul>
                            <br>
                            <p>Silahkan Masuk Ke Akun Anda . Awali Dengan Basmallah (بِسْمِ اللهِ الرَّحْمٰنِ الرَّحِيْم)</p>
